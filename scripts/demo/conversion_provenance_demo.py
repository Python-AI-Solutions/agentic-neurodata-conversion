...
def main():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        tracker.record_provenance(
            ...
            output_data={"format": "custom_binary", "channels": 64, "sampling_rate": 30000},
            confidence=0.95,
        ...
        tracker.record_provenance(
            ...
            input_data={"context": "64-channel extracellular recording from mouse visual cortex"},
            output_data={"session_description": "Extracellular recording from mouse V1 during visual stimulation"},
            confidence=0.85,
        ...
        tracker.record_provenance(
            ...
            output_data={"full_name": "Primary Visual Cortex", "ontology_id": "UBERON:0002436"},
            confidence=0.9,
