...
def push_to_github():
    ...
    print("Note: Subdatasets (catalystneuro conversions) are registered but not pushed.")
    ...
    print("datalad clone git@github.com:Python-AI-Solutions/agentic-neurodata-conversion.git")
