...
def compare_configurations() -> None:
    ...
    print(f"{'Setting':<25} {'Development':<12} {'Testing':<12} {'Staging':<12} {'Production':<12}")
    print("-" * 80)
    ...
    for setting_path, setting_name in settings_to_compare:
        ...
        print(f"{setting_name:<25} {values.get('development', 'N/A'):<12} "
...
def main():
    ...
    if args.json:
        ...
        import os
        env_vars = [
            "ANC_ENVIRONMENT", "ANC_DEBUG", "ANC_DATA_DIRECTORY", "ANC_LOG_LEVEL",
            "ANC_HTTP_HOST", "ANC_HTTP_PORT", "ANC_MCP_TRANSPORT", "ANC_ENABLE_AUTH",
            "ANC_API_KEY_HEADER", "ANC_ALLOWED_ORIGINS"
        ]
