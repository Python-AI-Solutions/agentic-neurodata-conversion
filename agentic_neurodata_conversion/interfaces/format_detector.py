...
class FormatDetector:
    ...
    async def extract_format_metadata(self, dataset_dir: str, format_name: str) -> Dict[str, Any]:
        """
    ...
    async def _extract_generic_metadata(self, dataset_dir: str, format_name: str) -> Dict[str, Any]:
