...
from ..core.tools import ConversionToolSystem, ToolCategory, ToolStatus
    ...
    def _register_handlers(self) -> None:
        ...
        async def list_resources() -> List[Resource]:
            ...
            if self.conversion_service:
                ...
                active_sessions = list(self.conversion_service.workflow_orchestrator.active_sessions.keys())
