...
from agentic_neurodata_conversion.agents.metadata_inference import MetadataInferenceEngine
...
class ConversationAgent:
    ...
    def _track_metadata_provenance(
        ...
        from agentic_neurodata_conversion.models import MetadataProvenance, ProvenanceInfo
...
Be warm, specific, and actionable. Keep it concise (2-3 sentences)."""
        ...
        if self._llm_service is None:
            logger.warning("LLM service not available, using fallback metadata message")
