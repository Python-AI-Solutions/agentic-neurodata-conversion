...
class SimpleMCPClient:
    ...
    def analyze_dataset(self, dataset_dir: str, use_llm: bool = False) -> Dict[str, Any]:
        ...
        """
        return self._call_tool("dataset_analysis", {
            "dataset_dir": dataset_dir,
            "use_llm": use_llm
        })

    def convert_dataset(self, metadata: Dict[str, Any], files_map: Dict[str, str]) -> Dict[str, Any]:
        """
        ...
        """
        return self._call_tool("conversion_orchestration", {
