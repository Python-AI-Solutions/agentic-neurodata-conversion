...
class TestDatasetInfrastructureIntegration:
    ...
    def test_end_to_end_dataset_creation_and_access(self, tmp_path):
        ...
        test_datasets = [
            d for d in available_datasets if d.name == f"integration_test_{test_id}"
        ]
    ...
    def test_dataset_accessor_integration(self, tmp_path):
        ...
        # Create accessor
        accessor = DatasetAccessor(dataset_manager=manager, enable_caching=True)
    ...
    def test_cache_integration(self, tmp_path):
        ...
        accessor = DatasetAccessor(
            dataset_manager=manager, cache_dir=str(cache_dir), enable_caching=True
        )
    ...
    def test_datalad_integration(self, tmp_path):
        ...
        dataset_info = manager.repo_manager.get_dataset_info(
            "formats/generic/datalad_test_dataset"
        )
