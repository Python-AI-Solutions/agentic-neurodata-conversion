...
class TestDataLadRepositoryManager:
    ...
    def test_datalad_initialization(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('agentic_neurodata_conversion.data_management.repository_structure.dl') as mock_dl:
                mock_dataset = Mock()
                ...
                mock_dl.create.assert_called_once_with(
                    path=temp_dir,
                    description="Agentic Neurodata Converter"
                )
    ...
    def test_install_subdataset(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('agentic_neurodata_conversion.data_management.repository_structure.dl') as mock_dl:
                ...
                # Mock Dataset class
                with patch('agentic_neurodata_conversion.data_management.repository_structure.Dataset') as mock_dataset_class:
                    mock_dataset = Mock()
...
class TestDataLadAvailability:
    ...
    def test_datalad_not_available_warning(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            # Mock DATALAD_AVAILABLE as False
            with patch('agentic_neurodata_conversion.data_management.repository_structure.DATALAD_AVAILABLE', False):
                manager = DataLadRepositoryManager(base_path=temp_dir)
