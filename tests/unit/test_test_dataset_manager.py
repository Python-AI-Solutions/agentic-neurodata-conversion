...
def temp_source_data(temp_repo_dir):
    ...
    (source_dir / "data.csv").write_text("timestamp,channel1,channel2\n1,0.1,0.2\n2,0.3,0.4\n")
...
class TestDatasetDiscovery:
    ...
    def test_get_available_datasets_with_data(self, dataset_manager, temp_source_data):
        ...
        dataset_manager.add_test_dataset("eval1", str(temp_source_data), "Eval 1", dataset_type="evaluation")
        dataset_manager.add_test_dataset("example1", str(temp_source_data), "Example 1", dataset_type="example")
    ...
    def test_get_dataset_path(self, dataset_manager, temp_source_data):
        ...
        dataset_manager.add_test_dataset("test_path", str(temp_source_data), "Test path")
    ...
    def test_get_datasets_by_format(self, dataset_manager, temp_source_data):
        ...
        dataset_manager.add_test_dataset("csv_dataset", str(temp_source_data), "CSV dataset")
        ...
        found_dataset = next((d for d in csv_datasets if d["name"] == "csv_dataset"), None)
...
class TestDatasetRemoval:
    ...
    def test_remove_existing_dataset(self, dataset_manager, temp_source_data):
        ...
        # Add a dataset first
        dataset_manager.add_test_dataset("to_remove", str(temp_source_data), "Will be removed")
...
class TestDatasetMetadata:
    ...
    def test_metadata_file_creation(self, dataset_manager, temp_source_data):
        ...
        metadata_file = dataset_manager.test_data_path / "metadata_test" / "dataset_metadata.json"
        assert metadata_file.exists()
