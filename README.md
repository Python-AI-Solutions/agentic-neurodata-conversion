...
- `CORE__ANTHROPIC_API_KEY`
- `GRAPH_DB__PASSWORD`

2) Start everything (guided CLI):
...
Common modes:
- Default (recommended): core services in docker, app/KG/frontend locally
- Full docker (core + KG + frontend): `pixi run start -- --kg docker --frontend docker`
