...
This design provides a comprehensive framework for agent implementations that are orchestrated by the MCP server, with clear interfaces, error handling, provenance tracking, and testing support.