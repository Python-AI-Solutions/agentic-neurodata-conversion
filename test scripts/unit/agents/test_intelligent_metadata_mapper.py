...
class TestCustomMetadataParsing:
    ...
    @pytest.mark.asyncio
    async def test_parse_custom_metadata_with_llm(
        self, sample_user_input, mock_llm_metadata_parser, global_state
    ):
        ...
        result = await mapper.parse_custom_metadata(
            sample_user_input,
            existing_metadata={},
            state=global_state
        )
    ...
    @pytest.mark.asyncio
    async def test_parse_custom_metadata_without_llm(
        self, mapper_without_llm, sample_user_input, global_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_parse_custom_metadata_malformed_input(
        self, mapper_with_llm, global_state
    ):
...
class TestNWBSchemaMapping:
    ...
    @pytest.mark.asyncio
    async def test_map_to_nwb_schema_complete(
        self, mapper_with_llm, global_state
    ):
        ...
        result = await mapper_with_llm._map_to_nwb_schema(
            extracted_fields,
            state=global_state
        )
    ...
    @pytest.mark.asyncio
    async def test_map_to_nwb_schema_species_conversion(
        self, mapper_with_llm, global_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_map_to_nwb_schema_age_conversion(
        self, mapper_with_llm, global_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_map_to_nwb_schema_sex_code_conversion(
        self, mapper_with_llm, global_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_map_to_nwb_schema_experimenter_array(
        self, mapper_with_llm, global_state
    ):
...
class TestFieldNameCleaning:
    ...
    def test_clean_field_name_spaces_to_underscores(
        self, mapper_with_llm
    ):
    ...
    def test_clean_field_name_remove_special_chars(
        self, mapper_with_llm
    ):
...
class TestMissingMetadataSuggestions:
    ...
    @pytest.mark.asyncio
    async def test_suggest_missing_metadata_partial(
        self, mapper_with_llm
    ):
        ...
        suggestions = await mapper_with_llm.suggest_missing_metadata(
            partial_metadata,
            file_type="spikeglx"
        )
    ...
    @pytest.mark.asyncio
    async def test_suggest_missing_metadata_complete(
        self, mapper_with_llm
    ):
    ...
    @pytest.mark.asyncio
    async def test_suggest_missing_metadata_empty(
        self, mapper_with_llm
    ):
...
class TestDisplayFormatting:
    ...
    def test_format_metadata_for_display_complete(
        self, mapper_with_llm, sample_extracted_metadata
    ):
        """Test formatting complete metadata for display."""
        formatted = mapper_with_llm.format_metadata_for_display(
    ...
    def test_format_metadata_for_display_nested(
        self, mapper_with_llm
    ):
...
class TestEdgeCasesAndErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_parse_metadata_with_special_chars(
        self, mapper_with_llm, global_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_map_to_nwb_schema_invalid_species(
        self, mapper_with_llm, global_state
    ):
    ...
    @pytest.mark.asyncio
    async def test_map_to_nwb_schema_invalid_age(
        self, mapper_with_llm, global_state
    ):
    ...
    async def test_llm_timeout_fallback(
        self, mapper_with_llm, mock_llm_service, sample_user_input, global_state
    ):
    ...
    def test_clean_field_name_only_special_chars(
        self, mapper_with_llm
    ):
...
class TestIntegrationScenarios:
    ...
    @pytest.mark.asyncio
    async def test_complete_metadata_mapping_workflow(
        self, mapper_with_llm, sample_user_input, global_state
    ):
