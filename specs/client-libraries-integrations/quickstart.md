...
This quickstart guide demonstrates how to use the MCP client library and CLI
tool for neurodata conversion. It covers installation, basic usage, and common
workflows.
