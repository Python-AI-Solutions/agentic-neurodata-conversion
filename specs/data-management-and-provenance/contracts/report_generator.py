...
class ReportGeneratorInterface(ABC):
    ...
    @abstractmethod
    def add_confidence_chart(self, confidence_distribution: dict[str, int]) -> None:
        """
    ...
    @abstractmethod
    def add_timeline_chart(self, activities: list[dict[str, Any]]) -> None:
        """
    ...
    def add_decision_chain(
        self, metadata_field: str, chain: list[str], final_value: Any, confidence: str
    ) -> None:
        """
    ...
    @abstractmethod
    def set_executive_summary(self, summary: str, key_metrics: dict[str, Any]) -> None:
        """
    ...
    @abstractmethod
    def generate_html(
        self, output_path: Path, embed_assets: bool = True, accessibility: bool = True
    ) -> Path:
        """
    ...
    def generate_html_string(
        self, embed_assets: bool = True, accessibility: bool = True
    ) -> str:
        """
    ...
    def add_raw_provenance_export(
        self, rdf_turtle: str, sparql_endpoint_url: Optional[str] = None
    ) -> None:
        """
    ...
    @abstractmethod
    def configure_template_variables(self, variables: dict[str, Any]) -> None:
        """
